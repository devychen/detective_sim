...
#         """
#         调用 LLM 并返回结果。
#         只允许传 max_tokens 和 temperature，避免与底层冲突。
#         """
#         allowed_keys = {"max_tokens", "temperature"}
#         safe_kwargs = {k: v for k, v in kwargs.items() if k in allowed_keys and v is not None}

#         response = self.llm.invoke(prompt, **safe_kwargs)
